        ...
        <Container>
            ...
            <Section id="video" className="flex items-center justify-center">
                <div className="md:max-w-3xl w-full md:p-1 relative z-0">
                    <video autoPlay={true} className="w-full h-full z-10"  controls={true}>
                ...
                <div className="md:max-w-3xl w-full md:p-1 relative z-0">
                    <div className="w-full lg:py-20 flex flex-col items-center justify-center">
                        <div className="w-full flex flex-col items-center mb-6">
                            <h1 className="text-xl md:text-3xl text-center font-bold text-blue-950">GRAND THEME</h1>
                            <p className="w-3/4 text-center text-sm md:text-lg text-yellow-600">
                        ...
                        <div className="w-full flex flex-col items-center">
                            ...
                            <p className="w-3/4 text-center text-sm md:text-md text-yellow-600">“Is it profitable to invest in green financial instruments?” and “Big challenges on audit sustainability report”</p>
                        </div>
                    </div>
                    <img className="absolute -top-20 -left-20 hidden md:block w-36" src={kincir1} alt="Kincir"/>
                    <img className="absolute -top-20 -right-20 hidden md:block h-28" src={pohon1} alt="Pohon"/>
